...
window.onload = async () => {
  try {
    ...
    const data = infos.data.slice(0, 6);
    const data2 = infos.data.slice(0, 25);
    ...
    data.forEach((data) => {
      console.log(data.album.title);
      const col = document.createElement("div");
      col.className = "col col-lg-4 col-md-6 col-6 gy-2 d-none";
      col.innerHTML = `
       <div class="card border border-0 d-flex flex-row">
       <a href="./album.html?albumId=${data.album.id}"><img class="image-type-1 img-card-top" src="${data.album.cover_medium}" alt="" /></a>
       <div class="card-body"><a href="./album.html?albumId=${data.album.id}" class="text-light">${data.album.title}</a></div>
    ...
    <a href="./album.html?albumId=${data2.album.id}" class="text-light"><img id='imgDefaultSearch' src="${data2.album.cover_medium}" class="card-img-top img-fluid " alt="..." /></a>
    ...
    //     <h5 class="card-title"><a href="./album.html?albumId=${dataa.album.id}" class="z-2 position-absolute text-light">${dataa.album.title}</a></h5>
    //   <div class=" card-body-2 card border border-0 ">

    //   <a href="./album.html?albumId=${dataa.album.id}" class="text-light"><img id='imgDefaultSearch' src="${dataa.album.cover_medium}" class="card-img-top img-fluid " alt="..." /></a>
    ...
    //   <h5 class="card-title"><a href="./album.html?albumId=${dataa.album.id}" class="z-2 position-absolute text-light">${dataa.album.title}</a></h5>
    //       <div  class="  card-body-2 card border border-0 ">
    //   <a href="./album.html?albumId=${dataa.album.id}" class="text-light"><img src="${dataa.album.cover_medium}" class="card-img-top img-fluid" alt="..." /></a>
